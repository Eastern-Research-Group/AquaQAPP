    ...
    records.push({
      ...
      instructions: `
        <div class="getting-started">
          ...
          <p>
            Before developing your QAPP using AquaQAPP, you should review the User Guide. It will also be helpful to
          ...
          <p>
            ...
            will also include a cover sheet prompting you to attach relevant maps, documents, and forms. Templates for the latter
            are available on MassBays’ website (<a
          ...
          <p>
            ...
            plans. The generated QAPP will also include 1) a cover sheet and checklist of items to edit prior to finalizing the
            document, with hyperlinks to those sections, and 2) a list of forms required as attachments to your final QAPP.
          </p>
          <p>
            When you use AquaQAPP to document and plan for collection of quality assured data, you will produce a QAPP that is
            considered pre-approved by MassDEP, and which should be acceptable to EPA, therefore agency review is not required prior
            to sampling. (Note that for any projects funded by their agencies, both MassDEP and EPA still require QAPP review prior
            to sampling.) This pre-approval is valid so long as samples are collected and analyzed in strict accordance with the QAPP
            generated by the application. While the generated QAPP is provided as a Microsoft Word document to enable minor editing,
            it should not be significantly altered from the original output. "Not significantly altered" means that the user has not
            made or will not make changes to sample collection protocols, analytical methods, or other substantive content included in
            the generated QAPP. Where new or revised methods, additional parameters, or other substantial changes are included beyond
            the content generated by AquaQAPP, and a stated objective of the monitoring effort is to submit the resulting data to
            MassDEP, QAPP review is required prior to implementation. See the User Guide for information on submitting a modified QAPP
            for approval.
          </p>
          <a href="#gettingStarted" class="top-of-page"><span class="fa fa-arrow-up"></span>Back to top</a>
